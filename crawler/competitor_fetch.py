...
STOP = set("스마트홈 스마트 삼성 삼성전자 LG 엘지 전자 구글 애플 아카라 통해 위해 대한 관련 이번 최대 최고 지원 출시 공개 진행 예정 확대 강화 개발 도입 적용 기능 서비스 제품 브랜드 오픈 시장 기술 사업 그리고 기자 사진 제공 무단 배포 금지 뉴스 기사 이날 관계자 지난 오는 올해 가장 함께 모든 다양한 통합 있다 없다 있는 없는 한다 된다 되는 하는 위한 통한 하나의 자동으로 사장은 인프라와 대상을 카메라가 영문 것으로 것이다 밝혔다 말했다 이라고 이라며 라며 라고 라는 또한 특히 기존 신규 계획 전망 새로운 국내 대표 이후 이전 현재 향후 대비 기준 위주 중심 각각 등을 등이 라고".split())
