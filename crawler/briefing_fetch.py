...
def gemini(cand):
    ...
    prompt = (
        ...
        "※ AX 예외: AX는 스마트홈에 국한하지 않는다. 산업 전반의 '주요 AI 전환 트렌드' 기사(생성형 AI·AI 에이전트·온디바이스 AI·AI 가전·AI 반도체·AI 인프라 등)는 스마트홈과 직접 관련이 없어도 그날 눈에 띄는 것을 1~3건 골라 AX로 분류하라. (단 여기서도 인물 프로필·인사·증시·부고·홍보성 나열 기사는 제외)\n"
